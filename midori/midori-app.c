...
midori_debug (const gchar* token)
{
    ...
    const gchar* debug_tokens = "wk2:no-multi-render-process adblock:match adblock:parse adblock:time adblock:element startup headers body referer cookies paths hsts unarmed bookmarks mouse app ";
    if (debug_token == NULL)
    {
        gchar* found_token;
